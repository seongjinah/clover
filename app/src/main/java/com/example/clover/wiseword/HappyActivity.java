...
public class HappyActivity extends Fragment {

    static HappyActivity instance;
    ...
    public static HappyActivity getInstance(){
        if(instance == null) instance = new HappyActivity();
        return instance;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_happy, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = getView().findViewById(R.id.happy_recyclerView);
        ...
        recyclerView.addOnItemTouchListener(new HappyActivity.RecyclerTouchListener(getActivity(), recyclerView, new DiaryActivity.ClickListener() {
